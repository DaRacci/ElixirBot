...
import dev.racci.elixir.utils.ResponseHelper.userDMEmbed
import dev.racci.elixir.utils.configPresent
import kotlinx.datetime.Clock
import kotlin.time.Duration

class ReportService : Extension() {
    ...
    override suspend fun setup() {
        ephemeralMessageCommand {
            ...
            action {
                ...
                val messageLog = guild?.getChannel(config.logChannel) as GuildMessageChannelBehavior
